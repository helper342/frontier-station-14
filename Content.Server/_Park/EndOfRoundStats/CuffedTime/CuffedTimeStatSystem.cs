...
using Content.Shared._Park.EndOfRoundStats.CuffedTime;
using Robust.Shared.Configuration;
using Robust.Shared.Timing;

namespace Content.Server._Park.EndOfRoundStats.CuffedTime;
...
public sealed class CuffedTimeStatSystem : EntitySystem
{
    ...
    private void OnUncuffed(EntityUid uid, CuffableComponent component, CuffedTimeStatEvent args)
    {
        ...
        //     mindComponent.Mind.Session.Name != null)
    ...
    private void OnRoundEnd(RoundEndTextAppendEvent ev)
    {
        ...
        if (topPlayer.Item2 < TimeSpan.FromMinutes(_config.GetCVar<int>(NF14CVars.CuffedTimeThreshold)))
            return;
        else
